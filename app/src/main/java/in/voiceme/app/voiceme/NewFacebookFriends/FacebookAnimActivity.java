...
public class FacebookAnimActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facebook_anim);

        coordinatorLayout = (WelcomeCoordinatorLayout) findViewById(R.id.coordinator_facebook);
...
//        personalContact = (TextView) findViewById(R.id.person_contact_verified);
        ...
        singlePrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(FacebookAnimActivity.this, PrivacyPolicy.class));
            }
        });
        ...
        final Button digitsAuthButton = (Button) findViewById(R.id.facebook_contact_id);
    ...
    public void contactMethod(){
        ...
        setAuthToken("token");
        startActivity(new Intent(FacebookAnimActivity.this, ContactListActivity.class));
    }
