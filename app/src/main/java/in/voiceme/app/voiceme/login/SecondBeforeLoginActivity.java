...
public class SecondBeforeLoginActivity extends AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(IntroFragment.newInstance("Diverse Culture", "Our Voice Me community have people from various backgrounds. Please Commit to respect each other.", R.drawable.social02, Color.parseColor("#4caf50")));
